...
export function FilterSelectionPage() {
  ...
  const [enhancedFilters, setEnhancedFilters] = useState<EnhancedFilters>({
    ...
    citationRange: initialFilters.citationRange || { min: 0, max: 200 },
    citationType: initialFilters.citationType || 'all',
    mediaQuality: initialFilters.mediaQuality || [],
  });
  ...
  const handleApply = () => {
    const filters = {
      ...
      // Include enhanced filters
      publishers: enhancedFilters.publishers,
      contentType: enhancedFilters.contentType,
      citationRange: enhancedFilters.citationRange,
      citationType: enhancedFilters.citationType,
      mediaQuality: enhancedFilters.mediaQuality,
    };
